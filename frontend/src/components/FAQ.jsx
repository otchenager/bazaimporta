...
const QUESTIONS = [
  {
    q: 'Как я получу доступ к каналу после оплаты?',
    a: 'После успешной оплаты вы будете добавлены в закрытый Telegram-канал в течение 24 часов. Убедитесь, что указали корректный Telegram username при оплате.',
  },
  {
  ...
  {
    q: 'Можно ли продлить доступ после окончания тарифа?',
    a: 'Да, вы можете в любой момент оформить новый тариф на нужный срок через тот же лендинг.',
  },
  {
    q: 'Что если оплата прошла, а доступ не появился?',
    a: 'Напишите нам в Telegram с указанием username и приблизительного времени оплаты — разберёмся в течение 24 часов.',
  },
  {
  ...
  {
    q: 'Можно ли оплатить из-за рубежа?',
    a: 'Оплата принимается через сервис Prodamus, поддерживающий основные способы оплаты для физических лиц в РФ.',
  },
]
